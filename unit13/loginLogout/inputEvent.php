<?php 
    //if you are a vaild user then you can access this page else redirect to login
    session_start();

    if(isset($_SESSION['vaildUser']) && $_SESSION['vaildUser']) {
        //allow access
    }
    else {
        //deny access return to login on home page
