...
//}
	...
	{	
		...
		//check for honey pot. if it contains content then ignore this form submission

		$presenterMessage = $_POST['presenter_message'];
		
		if(!empty($presenterMessage)){
			//invaild form - send error
			//stop process
			//return to homepage or form
			echo "Invaild Form Please Try Again";
			return;
			header("location: addPresenter.php");
		}
