...
?>
	...
	<p>Welcome to <?php echo $_POST["school_name"]; ?>! We hope you are successful at our school doing <?php echo $_POST["student_major"]; ?></p>

	<p>You are registered as: <?php echo $_POST["last_name"], ", ", $_POST["first_name"]; ?></p>

	<p>We have sent a confirmation registration to your email at <?php echo $_POST["email_address"]; ?>.</p>
