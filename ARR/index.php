...
<div class="border-bottom site-header sticky-top bg-white">
    ...
    <div class="bodyCon">
        <div class="homeCon">
            <h1>Welcome to Adel's Restaurant Reviews</h1>
            <h4>Here you will reviews I have done for restaurants I have been to. Whether I like them or not you can find them here!</h4>
            <button onclick="window.location.href='reviews.php'">My Reviews</button>
        </div>
    </div>
    <footer>
        <div class="container">
